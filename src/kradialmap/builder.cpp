...
KRadialMap::Builder::Builder( Map *m, const Directory* const d, bool fast )
  : m_map( m )
  , m_root( d )
...
void
KRadialMap::Builder::findVisibleDepth( const Directory* const dir, const unsigned int depth )
{
...
void
KRadialMap::Builder::setLimits( const unsigned int &b ) //b = breadth?
{
...
bool
KRadialMap::Builder::build( const Directory* const dir, const unsigned int depth, unsigned int a_start, const unsigned int a_end )
{
