...
void KRadialMap::Map::invalidate( const bool b )
{
  delete [] m_signature;
...
void KRadialMap::Map::make( const Directory *tree, bool refresh )
{
...
void KRadialMap::Map::setRingBreadth()
{
...
bool KRadialMap::Map::resize( const QRect &rect )
{
...
void KRadialMap::Map::paint( unsigned int scaleFactor )
{
